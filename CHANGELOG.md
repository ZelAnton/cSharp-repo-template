...
### Fixed
- Template initialization now changes only an explicit template-owned inventory, rejects local collisions and link-based path escapes, and rolls back late I/O failures.
