...
### Fixed
- Template initialization now changes only an explicit template-owned file inventory and rejects local target collisions before modifying the repository.
